                                ...
                                <div className="bg-warning card-body">
                                    <div className="media static-top-widget row">
                                        ...
                                        <div className="media-body col-8"><span className="m-0">Earnings</span>
                                            <h3 className="mb-0">AED <CountUp className="counter" end={6659} /><small> This Month</small></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="bg-secondary card-body">
                                    <div className="media static-top-widget row">
                                        ...
                                        <div className="media-body col-8"><span className="m-0">Products</span>
                                            <h3 className="mb-0">AED <CountUp className="counter" end={9856} /><small> This Month</small></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="bg-primary card-body">
                                    <div className="media static-top-widget row">
                                        ...
                                        <div className="media-body col-8"><span className="m-0">Messages</span>
                                            <h3 className="mb-0">AED <CountUp className="counter" end={893} /><small> This Month</small></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="bg-danger card-body">
                                    <div className="media static-top-widget row">
                                        ...
                                        <div className="media-body col-8"><span className="m-0">New Vendors</span>
                                            <h3 className="mb-0">AED <CountUp className="counter" end={45631} /><small> This Month</small></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table className="table table-bordernone">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="digits">AED6523</td>
                                                </tr>
                                                <tr>
                                                    <td>5</td>
                                                    <td className="digits">AED50.00</td>
                                            ...
                                            <div className="order-graph">
                                                ...
                                                <div className="order-graph-bottom">
                                                    <div className="media">
                                                        ...
                                                        <div className="media-body">
                                                            <h6 className="mb-0">Saint Lucia <span className="pull-right">AED157</span></h6>
                                                        </div>
                                                    </div>
                                                    <div className="media">
                                                        <div className="order-color-secondary"></div>
                                                        <div className="media-body">
                                                            <h6 className="mb-0">Kenya <span className="pull-right">AED347</span></h6>
                                                        </div>
                                                    </div>
                                                    <div className="media">
                                                        <div className="order-color-danger"></div>
                                                        <div className="media-body">
                                                            <h6 className="mb-0">Liberia<span className="pull-right">AED468</span></h6>
                                                        </div>
                                                    </div>
                                                    <div className="media">
                                                        <div className="order-color-warning"></div>
                                                        <div className="media-body">
                                                            <h6 className="mb-0">Christmas Island<span className="pull-right">AED742</span></h6>
                                                        </div>
                                                    </div>
                                                    <div className="media">
                                                        <div className="order-color-success"></div>
                                                        <div className="media-body">
                                                            <h6 className="mb-0">Saint Helena <span className="pull-right">AED647</span></h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
